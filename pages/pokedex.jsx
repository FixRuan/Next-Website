        ...
        <div className="w-full">
            <div className="w-screen h-[30vh] lg:h-[40vh] relative">
                <div className="absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] bg-black/80 z-100">
                    <Image className="absolute z-[-10]" layout="fill" objectFit="cover" src={PokedexImage} alt="/" />
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
                <div className="col-span-4">
                    ...
                    <p>
                        💙 Pokedex criada com React Native e consumindo a api de pokemons PokeApi.
                    </p>

                    <Link href="https://github.com/FixRuan/Pokedex-challenge">
